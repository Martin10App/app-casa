...
export const ICONS = {
  ...
  receipt:  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2.5-1.5L9 22l3-1.5L15 22l2.5-1.5L20 22V2l-2.5 1.5L15 2l-3 1.5L9 2 6.5 3.5z"/><path d="M8 7h8M8 11h8M8 15h5"/></svg>',
};
...
export const HOME_CARDS = [
  ...
  {
    id: 'compras-boletas', label: 'Boletas', cats: [], special: 'purchases',
    img: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?auto=format&fit=crop&w=900&q=75',
    icon: 'receipt', hue: 35, tagline: 'Sacá foto y carga todo solo',
  },
  {
